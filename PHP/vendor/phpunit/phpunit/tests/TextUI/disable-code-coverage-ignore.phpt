--TEST--
phpunit --colors=never --coverage-text=php://stdout --disable-coverage-ignore IgnoreCodeCoverageClassTest tests/_files/IgnoreCodeCoverageClassTest.php --whitelist ?php echo base_url(); ?>tests/_files/IgnoreCodeCoverageClass.php
--SKIPIF--
<?php
