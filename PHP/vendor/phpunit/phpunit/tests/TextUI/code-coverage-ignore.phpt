--TEST--
phpunit --colors=never --coverage-text=php://stdout IgnoreCodeCoverageClassTest ../_files/IgnoreCodeCoverageClassTest.php --whitelist ?php echo base_url(); ?>tests/_files/IgnoreCodeCoverageClass.php
--SKIPIF--
<?php
