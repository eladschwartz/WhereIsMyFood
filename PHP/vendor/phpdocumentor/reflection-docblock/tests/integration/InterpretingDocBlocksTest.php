...
class InterpretingDocBlocksTest extends \PHPUnit_Framework_TestCase
{
    public function testInterpretingASimpleDocBlock()
    {
         ...
         */
        include(__DIR__ . '/?php echo base_url(); ?>examples/01-interpreting-a-simple-docblock.php');
...
DESCRIPTION;
    ...
    public function testInterpretingTags()
    {
         ...
         * @var See[]    $seeTags
         */
        include(__DIR__ . '/?php echo base_url(); ?>examples/02-interpreting-tags.php');
    ...
    public function testDescriptionsCanEscapeAtSignsAndClosingBraces()
    {
        ...
        include(__DIR__ . '/?php echo base_url(); ?>examples/playing-with-descriptions/02-escaping.php');
